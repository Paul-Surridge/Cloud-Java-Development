    ...
    public static void main(String[] args) {
        ...
        /*
            Summary:
                ...
                1. Create container i.e. a context using ClassPathXmlApplicationContext("beans.xml"),
                2. ClassPathXmlApplicationContext is passed the beans.xml file which describes which beans that shall be instantiated and held within the container.
        ...
        */
        ...
        NumberGenerator numberGenerator = context.getBean("numberGeneratorImpl",NumberGeneratorImpl.class);
