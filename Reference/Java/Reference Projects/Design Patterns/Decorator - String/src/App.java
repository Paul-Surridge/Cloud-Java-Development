...
/*
    Decorator
        ...
        - If a class which can not be extended i.e. because it is final.
        - But would nonetheless be handy to be able to extend e.g. a String.
        - Then use the Decorator design pattern in order to encapsulate/aggregate the class that wish to extend:

            1. Have a private instance of the class that wish to extend.
            2. Delegate all original classes API (some IDE's auto complete e.g. IntelliJ).
            3. Add own necessary functions.

        - Aggregate Class: A class with multiple internal objects.
*/
...
class ExtendedString
{
  ...
  //Extend where necessary to incorporate the necessary additional methods.
...
public class App {
    ...
    {
        ExtendedString s = new ExtendedString("Hello");
