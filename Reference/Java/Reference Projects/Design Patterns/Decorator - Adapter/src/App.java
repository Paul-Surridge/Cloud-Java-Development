...
/*
    - It is possible to combine design patterns.
    - It is possible to have 'Adapter' traits within a 'Decorator'.
    - Adapter:      Get the interface you require from the interface that available.
    - Decorator:    Get the class you require from the class that available.
    - As shown below MyStringBuilder the 'Decorator' has effect of adding additional methods which are traits of 'Adapter'. 
*/

class MyStringBuilder
{
  //MyStringBuilder is an effective 'extended' StringBuilder which contains additional methods.
  ...
  // As part of the Decorator Design Pattern, add additional functionality around a StringBuilder (which is final).
  
  //Decorator Methods (which also perform 'Adapter' operations).
  //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  //NB: All of the auto generated methods below return a StringBuilder rather than a MyStringBuilder (this would need to be manually updated of course via Regex or otherwise)
